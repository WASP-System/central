 ...
 * @author 
 */
package edu.yu.einstein.wasp.gatk;
...
@ContextConfiguration(locations={"/gatk-test-launch-context.xml"})
 ...
 * 
 */
public class GatkTestSkeleton extends AbstractTestNGSpringContextTests{
	
	private final Logger logger = LoggerFactory.getLogger(GatkTestSkeleton.class);
	...
	public void testGatkTestSkeleton() throws Exception{
		try{
