...
// ContextConfiguration(locations={"/genomemetadata-test-launch-context.xml"})
 ...
 * 
 */
public class GenomeMetadataTestSkeleton { //extends AbstractTestNGSpringContextTests{
	
//	private final Logger logger = LoggerFactory.getLogger(GenomeMetadataTestSkeleton.class);
//	
//	/**
...
//	public void testGenomemetadataTestSkeleton() throws Exception{
//		try{
