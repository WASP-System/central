...
<div>
	<c:if test="${not empty controlList}">
		...
		<table class="data">
			<tr class="FormData">
				<td class="label-centered" style="background-color:#FAF2D6"><fmt:message key="helptag.helptagMspI.label"/></td>
				<td class="label-centered" style="background-color:#FAF2D6"><fmt:message key="helptag.helptagHpaIIorBetaGTMspI.label"/></td>
			</tr>
