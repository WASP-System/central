 ...
 * @author
 */
package edu.yu.einstein.wasp.plugin.rnaseq.batch.tasklet;
 ...
 * 
 */
public class RnaseqTasklet extends WaspRemotingTasklet {
	...
	public RnaseqTasklet() {
		// proxy
	}

	public RnaseqTasklet(String jobId) {
