 ...
 * @author asmclellan
 */
public class SnpEffPlugin extends WaspPlugin 
		implements 
			ClientMessageI {

	
	
	private static final long serialVersionUID = -1605840265032855360L;
	...
	@Autowired
	@Qualifier("snpEff")
	private Software snpEff;
	

	public SnpEffPlugin(String iName, Properties waspSiteProperties, MessageChannel channel) {
