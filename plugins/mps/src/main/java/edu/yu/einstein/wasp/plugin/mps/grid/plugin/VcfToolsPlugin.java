 ...
 * @author asmclellan
 */
public class VcfToolsPlugin extends WaspPlugin 
		implements 
			ClientMessageI {

	
	
	private static final long serialVersionUID = 3727499794673401980L;
	...
	@Autowired
	@Qualifier("vcfTools")
	private Software vcfTools;
	

	public VcfToolsPlugin(String iName, Properties waspSiteProperties, MessageChannel channel) {
