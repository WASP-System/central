 ...
 * @author asmclellan
 */
public class ImagemagickPlugin extends WaspPlugin 
		implements 
			ClientMessageI {

	
	
	private static final long serialVersionUID = 7762184214248621241L;
	...
	private Software imagemagick;
	

	public ImagemagickPlugin(String iName, Properties waspSiteProperties, MessageChannel channel) {
	...
	private Message<String> helloWorldHelp() {
		String mstr = "\nR plugin: hello world!\n" +
				"wasp -T imagemagick -t helloWorld\n";
