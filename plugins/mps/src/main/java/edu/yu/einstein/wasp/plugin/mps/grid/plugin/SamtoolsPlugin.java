 ...
 * @author asmclellan
 */
public class SamtoolsPlugin extends WaspPlugin 
		implements 
			ClientMessageI {

	
	private static final long serialVersionUID = 6358765631344323429L;
	...
	@Autowired
	@Qualifier("samtools")
	private Software samtools;
	

	public SamtoolsPlugin(String iName, Properties waspSiteProperties, MessageChannel channel) {
