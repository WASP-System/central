 ...
 * @author dubin
 */
public class BedtoolsPlugin extends WaspPlugin 
		implements 
			ClientMessageI {

	
	private static final long serialVersionUID = 594570455944978704L;
	...
	@Autowired
	@Qualifier("bedtools")
	private Software bedtools;
	

	public BedtoolsPlugin(String iName, Properties waspSiteProperties, MessageChannel channel) {
