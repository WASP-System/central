 ...
 * @author
 */
package edu.yu.einstein.wasp.plugin.bwameth.batch.tasklet;
 ...
 * 
 */
public class BwamethTasklet extends WaspRemotingTasklet {
	...
	public BwamethTasklet() {
		// proxy
	}

	public BwamethTasklet(String waspJobId) {
	...
	public GridResult doExecute(ChunkContext context) throws Exception {
		...
		//don't believe this is actually used any more:       saveGridResult(context, result);
	...
	public void doCleanupBeforeRestart(StepExecution stepExecution) throws Exception {
		...
		/* this code was stolen from macstwo tasklet
