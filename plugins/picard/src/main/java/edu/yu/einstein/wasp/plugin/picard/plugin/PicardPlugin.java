...
public class PicardPlugin extends WaspPlugin 
	...
	public static final String FLOW_NAME = "edu.yu.einstein.wasp.plugin.picard.mainFlow";

	public PicardPlugin(String pluginName, Properties waspSiteProperties, MessageChannel channel) {
	...
	private Message<String> launchTestFlowHelp() {
		String mstr = "\nPicard plugin: launch the test flow.\n" +
				"wasp -T picard -t launchTestFlow -m \'{id:\"1\"}\'\n";
		return MessageBuilder.withPayload(mstr).build();
	}
	...
	public Hyperlink getDescriptionPageHyperlink() {
		return new Hyperlink("picard.hyperlink.label", "/picard/displayDescription.do");
	}
