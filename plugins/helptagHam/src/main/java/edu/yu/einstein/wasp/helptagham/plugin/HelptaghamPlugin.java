 ...
 * @author 
 */
package edu.yu.einstein.wasp.helptagham.plugin;
 ...
 * @author 
 */
public class HelptaghamPlugin extends WaspPlugin 
		implements 
			BatchJobProviding,
			WebInterfacing,
			FileDataTabViewing,
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7409374168626107332L;
	...
	public HelptaghamPlugin(String iName, Properties waspSiteProperties, MessageChannel channel) {
	...
	private Message<String> helloWorldHelp() {
		String mstr = "\nHelptagham plugin: hello world!\n" +
				"wasp -T helptagham -t helloWorld\n";
	...
	private Message<String> launchTestFlowHelp() {
		String mstr = "\nHelptagham plugin: launch the test flow.\n" +
				"wasp -T helptagham -t launchTestFlow -m \'{id:\"1\"}\'\n";
		return MessageBuilder.withPayload(mstr).build();
	}
	...
	public Hyperlink getDescriptionPageHyperlink() {
		return new Hyperlink("helptagham.hyperlink.label", "/helptagham/displayDescription.do");
	}
