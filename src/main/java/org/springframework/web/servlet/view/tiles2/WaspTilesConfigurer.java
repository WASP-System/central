 ...
 */
public class WaspTilesConfigurer implements ServletContextAware, InitializingBean, DisposableBean {
	...
	private List<URL> getWildcardURLs(TilesApplicationContext applicationContext,String definition) {
		
	    List<URL> urls = new ArrayList<URL>();
	    try {
	        Set<URL> urlSet = applicationContext.getResources(definition);
	        for (URL url : urlSet) {
