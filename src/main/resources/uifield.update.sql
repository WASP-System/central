...
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','userPending','country','error','A country must be selected','1');
...
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','userPending','state','error','A state must be selected','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','userPending','state','constraint','NotEmpty','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','userPending','department','control','select:${department}:departmentId:name','1');
...
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','userPending','department','constraint','NotEmpty','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','userPending','department','error','A department must be selected','1');
