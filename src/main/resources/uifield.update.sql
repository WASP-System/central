...
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','piPending','emailconfirmed','label','Your email address has been confrimed and your department administrator has been emailed to request confirmation of your eligibility to register your lab. You are advised to contact them to request they do this if your account does not become activated in good time.','1');
