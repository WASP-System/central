...
/**
 * Tasklet to handle business logic associated with a run being stopped either normally or abnormally. A {@link StatusMessageTemplate} is sent to inform other flows of the fact.
 * @author andymac
 *
 */
public class RunCompleteTasklet implements Tasklet, ApplicationContextAware{
	
private final Logger logger = Logger.getLogger(RunCompleteTasklet .class);
	...
	public RepeatStatus execute(StepContribution arg0, ChunkContext arg1) throws Exception {
		...
		Message<WaspStatus> message =  WaspRunStatusMessageTemplate.build(runId, platformUnitId, WaspStatus.COMPLETED);
