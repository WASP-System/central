...
/**
 * Tasklet to handle business logic associated with a run being stopped either normally or abnormally. A {@link WaspStatusMessage} is sent to inform other flows of the fact.
 * @author andymac
 *
 */
