...
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','pageTitle','facility/platformunit/showPlatformUnit','label','Platform Unit / Sequence Run','1');
...
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','platformUnit','label','Platform Unit','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','type','label','Type','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','barcode','label','Barcode','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','platformUnitStatus','label','Platform Unit Status','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','unlocked','label','Unlocked','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','locked','label','Locked','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','update','label','Update','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','reset','label','Reset','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','createNewRun','label','Create New Run','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','warning1','label','Once You Create This Run Record,<br />Adding User Libraries To This Flow Cell Will Be Prohibited','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','runName','label','Run Name','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','machine','label','Machine','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','selectMachine','label','--SELECT A MACHINE--','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','readLength','label','Read Length','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','readType','label','Read Type','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','runTechnician','label','Run Technician','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','selectTechnician','label','--SELECT A TECHNICIAN--','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','startDate','label','Start Date (mm/dd/yyyy)','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','submit','label','Submit','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','cancel','label','Cancel','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','warning2','label','Adding Additional User Libraries To This Flow Cell<br />Is Now Prohibited','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','cell','label','Cell','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','index','label','Index','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','concOnCell','label','Conc. On Cell','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','pM','label','pM','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','removeControlFromThisCell','label','Remove Control From This Cell?','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','removeControl','label','Remove Control','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','noControlOnCell','label','No Control On Cell','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','addControl','label','Add Control','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','selectControl','label','--SELECT A CONTROL--','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','finalConcPM','label','Final Conc. (pM)','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','add','label','Add','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','jobJ','label','Job J','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','edit','label','Edit','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','currentConcPM','label','Current Conc. (pM)','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','newConcPM','label','New Conc. (pM)','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','noLibrariesOnCell','label','No Libraries On Cell','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','removeLibFromCell_alert','label','Remove Library From This Cell?','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','pleaseProvideValidName_alert','label','Please provide a valid name for this run','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','pleaseSelectMachine_alert','label','Please select a machine','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','pleaseSelectReadLength_alert','label','Please select a read length','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','pleaseSelectReadType_alert','label','Please select a read type','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','pleaseSelectTechnician_alert','label','Please select a technician','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','pleaseProvideStartDate_alert','label','Please provide a start date','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','pleaseProvideValidStartDate_alert','label','Please provide a start date in the proper format','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','submit_alert','label','Submit?','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','pleaseSelectControl_alert','label','Please select a control','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','pleaseProvideControlConc_alert','label','Please provide a final concentration for this control','1');
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','showPlatformUnit','pleasePorvideValue_alert','label','Please provide a value','1');
...
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','task','samplereceive','title_label','Incoming Sample Manager (Active Jobs Only)','1');
