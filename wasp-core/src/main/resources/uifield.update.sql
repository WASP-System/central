...
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','platformunit','submitter','error','Submitter cannot be empty','1');
...
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','jobDraft','numberofcells','label','Select number of cells required','1');
...
insert into uifield(locale,area,name,attrName,attrValue,lastupduser) values('en_US','jobDraft','cell_instructions','label','Please choose the number of cells you wish to order and then indicate which samples you wish to combine (multiplex) in the same lane','1');
