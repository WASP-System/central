...
/**
 * update/inserts db copy of subtype sample from bean definition takes in
 * properties - iname / internalname - name / label - uifields (List<UiFields>)
 * - platform - meta (List<ResourceMeta>) - cell (List<ResourceCells>)
 * 
 */
