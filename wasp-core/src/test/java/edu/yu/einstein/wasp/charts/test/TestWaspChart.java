...
public class TestWaspChart {
	...
	private String testJson = "{\"dataSeries\":[{\"rowLabels\":[\"1\",\"2\"],\"name\":\"box_and_whisker\",\"data\":[[1.1,1.6,2,3.5,4],[1.9,2.5,3.3,4,5.2]],\"properties\":{},\"colLabels\":[\"low\",\"lq\",\"median\",\"uq\",\"high\"]}],\"yAxisLabel\":\"Y-Axis\",\"title\":\"My Boxplot\",\"legend\":\"A nice boxplot of great data\",\"properties\":{},\"xAxisLabel\":\"X-axis\"}";
