package edu.yu.einstein.wasp.bisulseq;
...
@Controller
@Transactional
@RequestMapping("/jobsubmit/bisulSeq")
public class BisulSeqJobSubmissionController extends JobSubmissionController {
	...
	public String showBisulSeqPairForm (@PathVariable("jobDraftId") Integer jobDraftId, ModelMap m) {
		...
		return "jobsubmit/bisulseqform";
	}

	@RequestMapping(value="/pair/{jobDraftId}.do", method=RequestMethod.POST)
	@PreAuthorize("hasRole('jd-' + #jobDraftId)")
	public String updateBisulSeqPair(@PathVariable("jobDraftId") Integer jobDraftId, ModelMap m) {
