...
@Controller
@Transactional
@RequestMapping("/jobresults/helpTag")
public class HelpTagResultViewController extends WaspController {
	...
	public String treeView(ModelMap m) {
		...
		m.addAttribute("jobId", this.request.getParameter("jobId"));
		
		return "jobresults/helpTag/treeview"; 	
	}
