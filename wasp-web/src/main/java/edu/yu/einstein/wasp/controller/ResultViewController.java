...
*/			
	...
	private HashMap<String, Object> testTabPanelMockup(HashMap<String, Object> jsDetailsTabs,
			LinkedHashMap<String, Object> jsDetails) throws URISyntaxException {
...
//			webContent = new WebContent();
//			webContent.setHtmlCode("<img src='/wasp/images/Rplots.png' alt='msBayes Hilbert Curve'>");
//			panel = new WebPanel("Hilbert Curve", webContent);
//			jsDetails.put("panel"+panelId, panel);
//			panelId++;
//			
//			jsDetailsTabs.put("msBayes", jsDetails);
		
		return jsDetailsTabs;
	}
}
