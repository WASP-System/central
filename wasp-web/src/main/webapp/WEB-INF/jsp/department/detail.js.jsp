 ...
 <script type="text/javascript">
     ...
     function getAuthNames(){        
     	if( $("#adminName").val().length == 1){
	        	$.getJSON("<wasp:relativeUrl value='autocomplete/getUserNamesAndLoginForDisplay.do' />", { adminNameFragment: $("#adminName").val() }, function(data) { $("input#adminName").autocomplete(data);} );
     	}
	    }
 </script>
 <script type="text/javascript">
