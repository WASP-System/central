...
<form name="f" action="<c:url value='/auth/resetpassword/form.do'/>"
	...
	<table class="EditTable ui-widget ui-widget-content">
		...
		<tr class="FormData">
			...
			<td><img src="<c:url value='/stickyCaptchaImg.png'/>" alt="Captcha Image" /><br /><input class="FormElement ui-widget-content ui-corner-all" type='text' name='captcha_text' value='' /><span class="requiredField">*</span></td>
		</tr>
		<tr class="FormData">
