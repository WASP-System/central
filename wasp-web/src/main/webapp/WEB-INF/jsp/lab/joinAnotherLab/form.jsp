...
<h1><fmt:message key="pageTitle.lab/joinAnotherLab/form.label" /></h1>
  ...
  <form name="f" action="<c:url value='/lab/joinAnotherLab.do'/>" onsubmit="return validate();" method="POST">
  <table class="EditTable ui-widget ui-widget-content"><tr class="FormData">
    <td class="CaptionTD"><fmt:message key="lab.joinAnotherLab_WaspLoginNameOfPI.label" />: </td>
    <td class="DataTD"><br /><input class="FormElement ui-widget-content ui-corner-all" type='text' id='piLogin' name='piLogin' value=''/><span class="requiredField">*</span></td>
  </tr></table>
  <div class="submit">
