...
<c:choose>
	...
	<c:otherwise>
		...
		<form:form   cssClass="FormGrid" commandName="sample" method='post' name='editMacromoleculeForm' id='editMacromoleculeForm' action="" >
			...
			<table class="EditTable ui-widget ui-widget-content">
		 		...
		 		<%-- 	     
			     <tr class="FormData"><td colspan="3" class="submitBottom"><a class="button" href="javascript:void(0);" onclick='parent.loadNewPage(this, "<c:url value="/job/${job.getId()}/samples.do" />");' ><fmt:message key="sampledetail_ro.cancel.label" /></a>&nbsp;		
			  		<a class="button" href="javascript:void(0);" onclick='parent.loadIFrameAnotherWay(this, "<c:url value="/job/${job.getId()}/sample/${sample.getId()}/sampledetail_ro.do" />");' >cancel to ro</a>
			 	</td></tr>
				--%>	     
				    <tr class="FormData">
				        <td colspan="3" align="left" class="submitBottom">
				        	...
				        	--%>	
				        	<a class="button" href="javascript:void(0);"  onclick='loadNewPage(this, "<c:url value="/job/${job.getId()}/sample/${sample.getId()}/sampledetail_ro.do" />");' ><fmt:message key="sampledetail_rw.cancel.label" /></a>
				        	<a class="button" href="javascript:void(0);"  onclick='loadNewPage(this, "<c:url value="/job/${job.getId()}/sample/${sample.getId()}/sampledetail_rw.do" />");' >Reset</a>
							<a class="button" href="javascript:void(0);"  onclick='postFormWithAjaxJson("editMacromoleculeForm","<c:url value="/job/${job.getId()}/sample/${sample.getId()}/sampledetail_rw.do" />"); return false;' ><fmt:message key="sampledetail_rw.save.label" /></a>
