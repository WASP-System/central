...
CREATE TABLE `sample` (
  ...
  `sampletypeid` int(10) DEFAULT NULL,
  `subsampletypeid` int(10) DEFAULT NULL,
  ...
  KEY `fk_sample_stsid` (`subsampletypeid`),
  KEY `fk_sample_sjid` (`submitter_jobid`),
  KEY `fk_sample_slid` (`submitter_labid`),
  KEY `fk_sample_suid` (`submitter_userid`),
  CONSTRAINT `sample_ibfk_1` FOREIGN KEY (`sampletypeid`) REFERENCES `sampletype` (`sampletypeid`),
  CONSTRAINT `sample_ibfk_2` FOREIGN KEY (`subsampletypeid`) REFERENCES `subsampletype` (`subsampletypeid`),
...
CREATE TABLE `sampledraft` (
  ...
  KEY `fk_sampledraft_stsid` (`subsampletypeid`),
  ...
  CONSTRAINT `sampledraft_ibfk_2` FOREIGN KEY (`subsampletypeid`) REFERENCES `subsampletype` (`subsampletypeid`),
...
--
-- Table structure for table `subsampletype`
--

DROP TABLE IF EXISTS `subsampletype`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `subsampletype` (
  `subsampletypeid` int(10) NOT NULL AUTO_INCREMENT,
  `sampletypeid` int(10) DEFAULT NULL,
  `iname` varchar(50) DEFAULT NULL,
  `name` varchar(250) DEFAULT NULL,
  PRIMARY KEY (`subsampletypeid`),
  UNIQUE KEY `u_subsampletype_iname` (`iname`),
  KEY `fk_subsampletype_tsid` (`sampletypeid`),
  CONSTRAINT `subsampletype_ibfk_1` FOREIGN KEY (`sampletypeid`) REFERENCES `sampletype` (`sampletypeid`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `subsampletype`
--

LOCK TABLES `subsampletype` WRITE;
/*!40000 ALTER TABLE `subsampletype` DISABLE KEYS */;
INSERT INTO `subsampletype` VALUES (1,1,'chipseqDnaSample','ChIP-seq DNA'),(2,3,'chipseqLibrarySample','ChIP-seq Library'),(3,5,'illuminaFlowcellV3','Illumina Flow Cell Version 3');
/*!40000 ALTER TABLE `subsampletype` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `subsampletypemeta`
--

DROP TABLE IF EXISTS `subsampletypemeta`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `subsampletypemeta` (
  `subsampletypemetaid` int(10) NOT NULL AUTO_INCREMENT,
  `subsampletypeid` int(10) DEFAULT NULL,
  `k` varchar(250) DEFAULT NULL,
  `v` varchar(250) DEFAULT NULL,
  `position` int(10) DEFAULT '0',
  `lastupdts` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `lastupduser` int(10) DEFAULT '0',
  PRIMARY KEY (`subsampletypemetaid`),
  UNIQUE KEY `u_subsampletypemeta_k_sid` (`k`,`subsampletypeid`),
  KEY `fk_subsampletypemeta_sampleid` (`subsampletypeid`),
  CONSTRAINT `subsampletypemeta_ibfk_1` FOREIGN KEY (`subsampletypeid`) REFERENCES `subsampletype` (`subsampletypeid`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `subsampletypemeta`
--

LOCK TABLES `subsampletypemeta` WRITE;
/*!40000 ALTER TABLE `subsampletypemeta` DISABLE KEYS */;
INSERT INTO `subsampletypemeta` VALUES (1,3,'illuminaFlowcellV3.maxCellNumber','8',1,'2012-01-29 22:50:22',0);
/*!40000 ALTER TABLE `subsampletypemeta` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `subsampleresourcetypecategory`
--

DROP TABLE IF EXISTS `subsampleresourcetypecategory`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `subsampleresourcetypecategory` (
  `subsampleresourcetypecategoryid` int(10) NOT NULL AUTO_INCREMENT,
  `subsampletypeid` int(10) DEFAULT NULL,
  `resourcecategoryid` int(10) DEFAULT NULL,
  PRIMARY KEY (`subsampleresourcetypecategoryid`),
  KEY `fk_subsampleresourcetypecategory_stscid` (`subsampletypeid`),
  KEY `fk_subsampleresourcetypecategory_rcid` (`resourcecategoryid`),
  CONSTRAINT `subsampleresourcetypecategory_ibfk_1` FOREIGN KEY (`subsampletypeid`) REFERENCES `subsampletype` (`subsampletypeid`),
  CONSTRAINT `subsampleresourcetypecategory_ibfk_2` FOREIGN KEY (`resourcecategoryid`) REFERENCES `resourcecategory` (`resourcecategoryid`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `subsampleresourcetypecategory`
--

LOCK TABLES `subsampleresourcetypecategory` WRITE;
/*!40000 ALTER TABLE `subsampleresourcetypecategory` DISABLE KEYS */;
INSERT INTO `subsampleresourcetypecategory` VALUES (1,3,1);
/*!40000 ALTER TABLE `subsampleresourcetypecategory` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `resourcetype` VALUES (1,'mps','Massively Parallel DNA Sequencer'),(2,'amplicon','DNA Amplicon'),(3,'aligner','Aligner'),(4,'peakcaller','Peak Caller'),(5,'sanger','Sanger DNA Sequencer');
...
CREATE TABLE `sampletype` (
  ...
  UNIQUE KEY `u_sampletype_name` (`name`),
...
INSERT INTO `sampletype` VALUES (1,1,'dna','DNA'),(2,1,'rna','RNA'),(3,1,'library','Library'),(4,2,'cell','Cell'),(5,2,'platformunit','Platform Unit'),(6,1,'tissue','Tissue'),(7,1,'protein','Protein'),(8,1,'cellPrimary','Primary Cell'),(9,1,'cellLine','Cell Line');
...
CREATE TABLE `sampletypecategory` (
  ...
  UNIQUE KEY `u_sampletypecategory_name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `workflowsubsampletype`
--

DROP TABLE IF EXISTS `workflowsubsampletype`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `workflowsubsampletype` (
  `workflowsubsampletypeid` int(10) NOT NULL AUTO_INCREMENT,
  `workflowid` int(10) DEFAULT NULL,
  `subsampletypeid` int(10) DEFAULT NULL,
  PRIMARY KEY (`workflowsubsampletypeid`),
  UNIQUE KEY `u_subsampletype_wid_stsid` (`workflowid`,`subsampletypeid`),
  KEY `fk_workflowsubsampletype_stsid` (`subsampletypeid`),
  CONSTRAINT `workflowsubsampletype_ibfk_1` FOREIGN KEY (`subsampletypeid`) REFERENCES `subsampletype` (`subsampletypeid`),
  CONSTRAINT `workflowsubsampletype_ibfk_2` FOREIGN KEY (`workflowid`) REFERENCES `workflow` (`workflowid`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `workflowsubsampletype`
--

LOCK TABLES `workflowsubsampletype` WRITE;
/*!40000 ALTER TABLE `workflowsubsampletype` DISABLE KEYS */;
INSERT INTO `workflowsubsampletype` VALUES (3,1,1),(4,1,2);
/*!40000 ALTER TABLE `workflowsubsampletype` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `workflowresourcetype` VALUES (4,1,1),(5,1,3),(6,1,4);
