...
VALUES
	(1, NOW(), NOW(), X'2C6D49F3A5D84EEDB87E3C22025B44BD', 'system', 'Facilities Manager', 'fm', 1),
	(2, NOW(), NOW(), X'0589FFABBD55490BA1343DC8EFEF8BCC', 'system', 'System Administrator', 'sa', 1),
	(3, NOW(), NOW(), X'F2DB0D95263F4D339BD1E78D3AA7A604', 'system', 'General Administrator', 'ga', 1),
	(4, NOW(), NOW(), X'769766BF223444C887D5C10E12490FDA', 'department', 'Department Administrator', 'da', 1),
	(5, NOW(), NOW(), X'3151D7B3F0374B2092BFF606F4D12828', 'system', 'Facilities Tech', 'ft', 1),
	(6, NOW(), NOW(), X'84F5E255386A4A34A24C2C4D1D031C73', 'lab', 'Primary Investigator', 'pi', 1),
	(7, NOW(), NOW(), X'8033DF908D8446A69A24068D78ECC9AA', 'lab', 'Lab Manager', 'lm', 1),
	(8, NOW(), NOW(), X'0EA1959570574DBDA6787B8C56F4FD19', 'lab', 'Lab Member', 'lu', 1),
	(9, NOW(), NOW(), X'DBC4B5CA385A4C888C65305DC28A2F7B', 'job', 'Job Submitter', 'js', 1),
	(10, NOW(), NOW(), X'CB7CDC71FBD64FA0BE547E87A0B7BCA4', 'job', 'Job Viewer', 'jv', 1),
	(11, NOW(), NOW(), X'7B53E590C5BD47ADA7100496C5A75E1B', 'system', 'Super User', 'su', 1),
	(12, NOW(), NOW(), X'3A8A9BE81E09406FB2D291CCDA4319EE', 'lab', 'Lab Member Inactive', 'lx', 1),
	(13, NOW(), NOW(), X'776EA13A2B5F48FD9A567A87A0DBCB52', 'lab', 'Lab Member Pending', 'lp', 1),
	(14, NOW(), NOW(), X'A01EE1989D9E4768925FF5FD795E2535', 'jobdraft', 'Job Drafter', 'jd', 1),
	(15, NOW(), NOW(), X'D656858CDB434502B438B4A3A2724D00', 'user', 'User', 'u', 1),
	(16, NOW(), NOW(), X'D8A80927B7B645C2A5DF14D1605D838B', 'system', 'wasp', 'w', 1);
...
INSERT INTO `wuser` (`id`, `created`, `updated`, `uuid`, `email`, `firstname`, `isactive`, `lastname`, `locale`, `login`, `password`, `lastupdatebyuser`)
VALUES (2, NOW(), NOW(), X'1B9BF789DF334FC98C3CF17C1F47B184', 'super@super.com', 'Super', 1, 'User', 'en_US', 'super', SHA1('user'), 1);


INSERT INTO `userrole` (`id`, `created`, `updated`, `uuid`, `roleid`, `userid`, `lastupdatebyuser`)
VALUES
	(1, NOW(), NOW(), X'E4098C7735FC47099BD28EBC1BD8C179', 16, 1, 1),
	(2, NOW(), NOW(), X'7F8A8057033D4407B9ED84F4AFBD47B4', 11, 2, 1);
	


INSERT INTO `lab` (`id`, `created`, `updated`, `uuid`, `departmentid`, `isactive`, `name`, `primaryuserid`, `lastupdatebyuser`)
VALUES
	(1, NOW(), NOW(), X'0EAC44BADD344B768BFD44DBFB52603A', 1, 1, 'Default lab', 2, 1);


INSERT INTO `labuser` (`id`, `created`, `updated`, `uuid`, `labid`, `roleid`, `userid`, `lastupdatebyuser`)
VALUES
	(1, '2012-05-23 15:55:46', '2013-03-12 09:42:14', X'74DDE5796D7E45C48D21CCBA8C64CCB6', 1, 6, 2, 1);
...
VALUES
	...
	(12, '2012-05-23 17:23:00', '2013-03-12 12:26:59', X'6E13313212C340C4AAA02DD9C19BB885', 'user.title', 0, NULL, 'Mr', 2, 1),
	(13, '2012-05-23 17:23:00', '2013-03-12 12:26:59', X'33FDDCA4EC3346F686E2D880AE9ADD3D', 'user.institution', 0, NULL, 'Wasp', 2, 1),
	(14, '2012-05-23 17:23:00', '2013-03-12 12:26:59', X'F3586BCDB42F42BD8DCF96DE38375D22', 'user.departmentId', 0, NULL, '1', 2, 1),
	(15, '2012-05-23 17:23:00', '2013-03-12 12:26:59', X'ACA76B8C2D7C49C4B254B4C1CD86C640', 'user.building_room', 0, NULL, 'N/A', 2, 1),
	(16, '2012-05-23 17:23:00', '2013-03-12 12:26:59', X'E6C44F62B021458C925E3C0C9B29A9F1', 'user.address', 0, NULL, 'N/A', 2, 1),
	(17, '2012-05-23 17:23:00', '2013-03-12 12:26:59', X'9FE1D84054F94F6AA5855CE082CFD675', 'user.city', 0, NULL, 'N/A', 2, 1),
	(18, '2012-05-23 17:23:00', '2013-03-12 12:26:59', X'B04816B731EC41A8ACE6D403096E2B6C', 'user.state', 0, NULL, 'NY', 2, 1),
	(19, '2012-05-23 17:23:00', '2013-03-12 12:26:59', X'6CD39EADCD5947248E5CB0110860068E', 'user.country', 0, NULL, 'US', 2, 1),
	(20, '2012-05-23 17:23:00', '2013-03-12 12:26:59', X'685F9541D4334A63BD104B8E5F3453E7', 'user.zip', 0, NULL, '00000', 2, 1),
	(21, '2012-05-23 17:23:00', '2013-03-12 12:26:59', X'47A25DBCAB754F2FB8435E7C3299F0A3', 'user.phone', 0, NULL, '000-000-0000', 2, 1),
	(22, '2012-05-23 17:23:00', '2013-03-12 12:26:59', X'55D76797BDAD4FE7BD4617D189923731', 'user.fax', 0, NULL, '000-000-0000', 2, 1);
