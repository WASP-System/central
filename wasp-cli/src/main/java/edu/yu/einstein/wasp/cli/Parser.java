...
public class Parser {
	...
	public Parser(String[] args) {
		...
		options.addOption(new Option("l", "list", true, "possible values: plugins, software, builds, sampleSubtypes, workflows, fileTypes, cellLibraries, users or a combination e.g. -l plugins,builds"));
